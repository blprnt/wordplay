				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Re-initializes the grammar from a file containing the grammar rules</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>loadFile(grammarFileNAme, callbackOrPApplet)</pre></td>
						</tr>
						...
						<tr class="">
							...
							<!-- PLATFORM  -->
							<td>In Javascript, uses JQuery's ajax() method if available, otherwise attempts an invisible iframe-hack, then calls the specified callback function. Alternatively, one can use the &lt;script src=...&gt; tag to include the JSON grammar file in an html page.</td>
						</tr>
