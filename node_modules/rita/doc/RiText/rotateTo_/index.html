				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rotateTo(angleInRadians)<br/>rotateTo(angleInRadians, seconds)<br/>rotateTo(angleInRadians, seconds, delay)<br/>rotateTo(angleInRadians, seconds, delay, callback)</pre></td>
						</tr>
