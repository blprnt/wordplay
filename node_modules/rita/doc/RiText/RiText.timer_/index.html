				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Starts a timer that calls 'onRiTaEvent' or the specified callback every 'period' seconds</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.timer(period, callback)</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>period (in seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>function</th><td width='75%'>callback called every 'period' seconds (default=onRiTaEvent)</td></tr>
							</table></td>
						</tr>
